  ...
  tables: [
    tableSchema({
      ...
      columns: [
        ...
        {name: 'selectedValuejdi_id', type: 'string'},
        ...
        {name: 'selectedValuetub_id', type: 'string'},
        ...
        {name: 'selectedValuejdiobs_id', type: 'string'},
        ...
        {name: 'selectedValuetubobs_id', type: 'string'},
